          ...
          <ul className="list-group">
            ...
            <li className="list-group-item headliner">
              {event.headliner.url === "" ? (
                ...
                <a href={event.headliner.fields.url} rel="noreferrer">
                  {event.headliner.fields.name}
                </a>
              )}
            </li>
            ...
            <li className="list-group-item support">
              {event.openers.map((dj) =>
                dj.url === "" ? (
                  <a key={dj.fields.name} className="support-a">
                    {dj.fields.name}
                  </a>
                ) : (
                  <a
            ...
            <li className="list-group-item time">
              ...
              {moment(startTime).format("h:mma") === "Invalid date"
                ? "???"
                : moment(startTime).format("h:mma")}{" "}
              -{" "}
              {moment(endTime).format("h:mma") === "Invalid date"
                ? "???"
